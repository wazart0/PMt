...
availability as (
	select 
		...
		generate_series(selected_availability.start + selected_availability.duration, coalesce (selected_availability.until, timestamptz '2022-12-30'), selected_availability.repeat_interval) as end
	from
