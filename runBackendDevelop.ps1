...
docker.exe exec -it pmt_backend_1 python3 ./backend/restServer/initialize/createUsers.py
docker.exe exec -it pmt_backend_1 python3 ./backend/restServer/initialize/createGroups.py
